#' @title rra_PEre
#'
#' @description The implementation of reduced-rank approach with pricing error
#'              restrictions by Dashan Huang et al. (MS, 2022)
#'
...
#' data(r48)
#' data(proxies)
#' rra48_w <- rra_main(r48, proxies, K=3, S2)
